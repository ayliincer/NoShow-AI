...
def zaman_tiplerini_donustur_ve_dogrula(veri: pd.DataFrame) -> pd.DataFrame:
    ...
    if "appointment_date" in veri.columns and "entry_service_date" in veri.columns:
        ...
        print("\nNot:")
        print("Bu aşamada kronolojik tutarsızlık taşıyan gözlemler yalnızca raporlanmıştır.")
        print("Herhangi bir kayıt silinmemiştir.")
        print("Bu kayıtların modele etkisi veri ön işleme aşamasında ayrıca değerlendirilecektir.")
