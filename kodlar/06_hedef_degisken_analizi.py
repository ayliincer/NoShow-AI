...
def aykiri_deger_sinirlarini_hesapla(veri: pd.DataFrame):
    ...
    # (under_12_years_old, over_60_years_old, patient_needs_companion, rainy_day_before, storm_day_before)
    # sürekli sayısal değişken olmadıkları için bu spesifik analizin dışarısında tutulur.
