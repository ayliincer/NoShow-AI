"""
21b_mlp_hiperparametre_aramasi.py

AMAÇ (Hakem Eleştirisi Güçlendirme - Eksiklik #2 Takibi):
21. script'teki MLP tek bir sabit mimariyle (64,32) ve hiperparametre araması
YAPILMADAN değerlendirilmişti. Bu, "derin öğrenme adil koşullarda denenmedi"
eleştirisine açık kapı bırakır. Bu script, MLP için SADECE EĞİTİM SETİ + CV
üzerinde küçük ama gerçek bir hiperparametre araması yürütür, ardından en iyi
mimariyi saklı dış test setinde TEK SEFER değerlendirir.
"""
import time
import numpy as np
import pandas as pd
...
def main():
    ...
    cv = StratifiedKFold(n_splits=3, shuffle=True, random_state=42)  # hesaplama bütçesi nedeniyle 3 kat
