...
├── kodlar/       # Numaralı, sıralı pipeline script'leri (01–40)
...
- **Pseudo-ID duyarlılık analizi (script 32, 35):** Vekil hasta kimliğinin çakışma/bölünme oranları ölçülmüş; zaman-stabil kurtarmanın (0,548'den 0,642'ye) büyük kısmının temel özniteliklerden geldiği, proxy geçmişinin katkısının yalnızca +0,009 olduğu doğrulanmıştır.
